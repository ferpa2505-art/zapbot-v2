...
contextBridge.exposeInMainWorld('zapbot', {
  ...
  licencaPermiteIA:   ()      => ipcRenderer.invoke('licenca-permite-ia'),
  ...
  testarIA:           (key)   => ipcRenderer.invoke('testar-ia', key),

  // Conversas / Backup
  conversasListar:      ()      => ipcRenderer.invoke('conversas-listar'),
  conversasLimpar:      (jid)   => ipcRenderer.invoke('conversas-limpar', jid),
  conversasLimparTodas: ()      => ipcRenderer.invoke('conversas-limpar-todas'),
  backupAgora:          ()      => ipcRenderer.invoke('backup-agora'),

  // Pausar conversas
  pausarConversa:       (num)   => ipcRenderer.invoke('pausar-conversa', num),
  retomarConversa:      (jid)   => ipcRenderer.invoke('retomar-conversa', jid),
  listarPausadas:       ()      => ipcRenderer.invoke('listar-pausadas'),
